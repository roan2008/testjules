...
<form method="post">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><input type="text" name="EmptyTubeNumber" value="<?php echo htmlspecialchars($order['EmptyTubeNumber']); ?>" class="form-control"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <select name="MC02_Status" class="form-select">
    ...
    <h2>Liner Usage</h2>
    <table id="linerTable" class="table table-bordered">
        <thead>
            <tr>
                <th>Liner Type</th>
                <th>Batch Number</th>
        ...
        <tbody>
            <?php if (!empty($liners)): ?>
                <?php foreach ($liners as $index => $liner): ?>
                    <tr>
                        <td><input type="text" name="liner[<?php echo $index; ?>][LinerType]" value="<?php echo htmlspecialchars($liner['LinerType']); ?>" class="form-control"></td>
                        <td><input type="text" name="liner[<?php echo $index; ?>][LinerBatchNumber]" value="<?php echo htmlspecialchars($liner['LinerBatchNumber']); ?>" class="form-control"></td>
                        <td><input type="text" name="liner[<?php echo $index; ?>][Remarks]" value="<?php echo htmlspecialchars($liner['Remarks']); ?>" class="form-control"></td>
        ...
        <tbody>
            <?php if (!empty($logs)): ?>
                <?php foreach ($logs as $index => $log): ?>
                    <tr>
                        <td><input type="number" name="log[<?php echo $index; ?>][SequenceNo]" value="<?php echo $log['SequenceNo']; ?>" style="width: 60px;" class="form-control"></td>
                        <td><input type="text" name="log[<?php echo $index; ?>][ProcessStepName]" value="<?php echo htmlspecialchars($log['ProcessStepName']); ?>" class="form-control"></td>
                        <td><input type="date" name="log[<?php echo $index; ?>][DatePerformed]" value="<?php echo $log['DatePerformed']; ?>" class="form-control"></td>
                        <td><input type="text" name="log[<?php echo $index; ?>][Result]" value="<?php echo htmlspecialchars($log['Result']); ?>" class="form-control"></td>
                        <td><input type="number" name="log[<?php echo $index; ?>][Operator_UserID]" value="<?php echo $log['Operator_UserID']; ?>" style="width: 80px;" class="form-control"></td>
                        <td><input type="number" step="0.001" name="log[<?php echo $index; ?>][ControlValue]" value="<?php echo $log['ControlValue']; ?>" style="width: 90px;" class="form-control"></td>
                        <td><input type="number" step="0.001" name="log[<?php echo $index; ?>][ActualMeasuredValue]" value="<?php echo $log['ActualMeasuredValue']; ?>" style="width: 90px;" class="form-control"></td>
                        <td><textarea name="log[<?php echo $index; ?>][Remarks]" rows="2" class="form-control"><?php echo htmlspecialchars($log['Remarks']); ?></textarea></td>
                        <td><button type="button" onclick="removeRow(this)" class="btn btn-secondary">Remove</button></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td><input type="number" name="log[0][SequenceNo]" value="1" style="width: 60px;" class="form-control"></td>
                    <td><input type="text" name="log[0][ProcessStepName]" class="form-control"></td>
                    <td><input type="date" name="log[0][DatePerformed]" class="form-control"></td>
                    <td><input type="text" name="log[0][Result]" class="form-control"></td>
                    <td><input type="number" name="log[0][Operator_UserID]" style="width: 80px;" class="form-control"></td>
                    <td><input type="number" step="0.001" name="log[0][ControlValue]" style="width: 90px;" class="form-control"></td>
                    <td><input type="number" step="0.001" name="log[0][ActualMeasuredValue]" style="width: 90px;" class="form-control"></td>
                    <td><textarea name="log[0][Remarks]" rows="2" class="form-control"></textarea></td>
                    <td><button type="button" onclick="removeRow(this)" class="btn btn-secondary">Remove</button></td>
                </tr>
            <?php endif; ?>
        </tbody>
...
<script>
    ...
    function addLinerRow() {
        ...
        newRow.innerHTML = `
            <td><input type="text" name="liner[${linerRowCount}][LinerType]" class="form-control"></td>
            <td><input type="text" name="liner[${linerRowCount}][LinerBatchNumber]" class="form-control"></td>
            <td><input type="text" name="liner[${linerRowCount}][Remarks]" class="form-control"></td>
            <td><button type="button" onclick="removeRow(this)" class="btn btn-secondary">Remove</button></td>
        `;
        linerRowCount++;
    }
    ...
    function addLogRow() {
        ...
        const newRow = table.insertRow();
        newRow.innerHTML = `
            <td><input type="number" name="log[${logRowCount}][SequenceNo]" value="${logRowCount + 1}" style="width: 60px;" class="form-control"></td>
            <td><input type="text" name="log[${logRowCount}][ProcessStepName]" class="form-control"></td>
            <td><input type="date" name="log[${logRowCount}][DatePerformed]" class="form-control"></td>
            <td><input type="text" name="log[${logRowCount}][Result]" class="form-control"></td>
            <td><input type="number" name="log[${logRowCount}][Operator_UserID]" style="width: 80px;" class="form-control"></td>
            <td><input type="number" step="0.001" name="log[${logRowCount}][ControlValue]" style="width: 90px;" class="form-control"></td>
            <td><input type="number" step="0.001" name="log[${logRowCount}][ActualMeasuredValue]" style="width: 90px;" class="form-control"></td>
            <td><textarea name="log[${logRowCount}][Remarks]" rows="2" class="form-control"></textarea></td>
            <td><button type="button" onclick="removeRow(this)" class="btn btn-secondary">Remove</button></td>
        `;
        logRowCount++;
    }
